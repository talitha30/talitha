    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_move_data:
                startActivity(new Intent(MainActivity.this,MoveActivityWithData.class).putExtra(MoveActivityWithData.EXTRA_NAME,"Talitha Safa Nabila").putExtra(MoveActivityWithData.EXTRA_AGE,19));
                break;
            case R.id.btn_dial_phone:
                String phoneNumber = "085729882781";
